...
export default function TeachersData() {
        ...
        <div className="table-wrapper">
          <div className="table-title">
            <div className="row title-row">
              <div className="">
                <h2>
                  Manage <b style={{ display: "block" }}>teachers Data</b>
                </h2>
              </div>
              <div className="">
                <Link to="/teacherForm">
                  <Button
                    ...
                    variant="success"
                    onClick={() => {
                      context.setcreateteacher("create");
                    }}
                  >
                    <i
          ...
          <div className="table-responsive">
            <table className="table table-striped table-hover">
              ...
              <tbody>
                {context.teacherData.length > 0 &&
                  context.teacherData.map((user, index) => {
                    return (
                      <tr key={user.id}>
                        ...
                        <td data-label="Action:" className="action-bar">
                          <Link
                            ...
                            className="edit"
                            onClick={(e) => {
                              context.getteacherById(e.target.id);
                              context.setcreateteacher("edit");
                            }}
                          >
                            <i
          ...
          >
            <div className="modal-btn">
              ...
              <Button
                ...
                onClick={(e) => {
                  context.handleDeleteteacher(deleteId);
                  handleClose();
                }}
              >
                Delete
